...
export default function UserDashboard() {
  ...
  return (
    ...
    >
      ...
      <div
        className="user-dashboard-body full min-0 overflow-hidden grid"
        style={{ gridTemplateColumns: "minmax(0, 1fr) auto" }}
        dir="ltr"
      >
        <main className="user-dashboard-main min-0 overflow-hidden grid gap-3">
          <div
        ...
        <SideMenu defaultCollapsed={false} />
      </div>
    </section>
  );
}
